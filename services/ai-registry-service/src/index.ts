...
app.get('/', (req, res) => {
  res.json({
    service: 'AI Registry Service',
    version: '1.0.0',
    description: 'AI technology catalog and dataset provenance tracking service',
    endpoints: {
      health: '/health',
...
app.listen(PORT, async () => {
  logger.info(`AI Registry Service running on port ${PORT}`);
